<?php
/**
 * ImprooveZend_Sniffs_NamingConventions_ValidFunctionNameSniff.
 *
 * PHP version 5
 *
 * @category  PHP
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class ImprooveZend_Sniffs_NamingConventions_ValidFunctionNameSniff extends PHP_CodeSniffer_Standards_AbstractScopeSniff
{
    ...
    /**
     * Constructs a ImprooveZend_Sniffs_NamingConventions_ValidFunctionNameSniff.
     */
    ...
    protected function processTokenWithinScope(PHP_CodeSniffer_File $phpcsFile, $stackPtr, $currScope)
    {
        ...
        if ($isPublic === false && $methodName{0} !== '_') {
            ...
            } else if ($methodProps['scope'] === 'protected') {
